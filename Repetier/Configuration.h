...
#define X_MAX_LENGTH 365
#define Y_MAX_LENGTH 365
#define Z_MAX_LENGTH 362.11
...
*/
#define PRINTER_RADIUS 200.39
#define POVEDAL_SOM_JA //temp  ->> delta_radius 132.4 treba nastavit do eeprom!!!!!
...
/** After x seconds of inactivity, the system will go down as far it can.
    ...
    Overridden if EEPROM activated.
*/
#define MAX_INACTIVE_TIME 14400
