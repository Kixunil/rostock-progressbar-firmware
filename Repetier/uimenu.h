...
#define UI_PAGES {&name1,&name2,&name3}
*/
 #define UI_PAGES {&ui_page1,&ui_page2,&ui_page3 UI_PRINTTIME_PAGES}  //{&ui_page1 UI_PRINTTIME_PAGES}
// How many pages do you want to have. Minimum is 1.
 #define UI_NUM_PAGES 3+UI_PRINTTIME_COUNT  //1+UI_PRINTTIME_COUNT
#else
#if HAVE_HEATED_BED==true
...
/*
#define UI_MENU_MAIN {UI_MENU_ADDCONDBACK  &ui_menu_main1,&ui_menu_sd_printfile,,UI_MENU_FAN_COND UI_MENU_SD_COND &ui_menu_main5}
UI_MENU(ui_menu_main,UI_MENU_MAIN,4+UI_MENU_BACKCNT+UI_MENU_SD_CNT+UI_MENU_FAN_CNT);
*/
#define UI_MENU_MAIN { UI_MENU_ADDCONDBACK &ui_menu_main1, UI_MENU_SD_COND &ui_menu_main6,&ui_menu_main2,&ui_menu_main3,UI_MENU_FAN_COND  &ui_menu_main4,&ui_menu_main5 }
